...
public class TarefasController {
    ...
    public ResponseEntity<TarefasDTOResponse> gravarTarefas(@RequestBody TarefasDTORequest dto, @RequestHeader(value = "Authorization", required = false) String token) {
    ...
    @PutMapping
    @Operation(summary = "Altera dados de tarefa", description = "Altera dados da tarefa cadastrada")
